...
{No. of nights requested: 3 }(total exposure time and calculations in section \textbf{10})\\
{Preferred dates: None} & {Impossible dates: August 1 to August 31}\\
 & \\
 & \\
 & \\
 & \\
...
To calculate the exposures in the optical, we normalise the maximum light observations of SN2001el (a well-observed normal Ia) to the peak of SN2014J in the $BVRI$ filters. As a result, we use the predicted fading of SN2014J to get the magnitudes at these late phases. 
...
The total time for each epoch, optical + IR is 2.5 hours.
 Hence, the total time requested for the semester is 3 X 2.5 = 7.5 hours. 
\\
\\
\\
...
We have downloaded the SED templates for M82 for accurate host galaxy subtraction. 
...
\hline
SN2014J & 09 55 42.12 & +69 40 25.9  &  & 20.31 &  N/A  \\\hline
 & & & & & \\\hline
...
\begin{figure}
\includegraphics[width=\textwidth, trim=0 60 30 0]{sn01el_allbw.pdf}
\caption{}
\end{figure}
\end{document}
