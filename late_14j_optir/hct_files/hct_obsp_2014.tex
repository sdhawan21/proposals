...
Using the exposure time calculator for the TIRSPEC we would like to have 5 dithers for 4 frames of 15 seconds each for the J, H, and K bands, which is a total of 300s for each filter. 

For the optical measurements, we would like 
\\
\\
\\
\\
