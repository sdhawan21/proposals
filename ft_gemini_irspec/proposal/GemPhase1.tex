...
% Spectroscopically following the SN provides a constraint on the ionisation state and temperature and hence allows us to deduce the presence of an IRC. 
...
\bibitem[\protect\citeauthoryear{Spyromilio et 
al.}{2004}]{S04} Spyromilio J., Gilmozzi R., Sollerman J., Leibundgut B., Fransson C., Cuby J.-G., 2004, A\&A, 426, 547 
