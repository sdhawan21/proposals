...
\Title{Very late time Near Infrared observations of Type Ia Supernovae}  
...
\Abstract{The luminosity of Type Ia supernova is powered by the radioactive decay of $^{56}$Ni and its daughter nuclei. At very late 
epochs, escape of $\gamma$ rays implies that the total energy is dominated by the positron decay channel. Thus, the very late time light curve allows us to
place constraints on the amount of positron trapping and hence, the nature of the weak magnetic field at late times. Due to the faintness of the explosion, there have been very few observations of SNIa at such late epochs. We
aim to observe nearby objects at close to 2 years after explosion to obtain the late time pseudo-bolometric light curves}
...
\ScientificRationale{Type Ia supernovae have been used as distance indicators for cosmology. Their use in constraining cosmological parameters is dependent on understanding the physics of the explosions and 
how they can be normalized to reduce the error in distance measurements. There are several open  questions regarding the nature of SNIa which require observations at very late epochs, both in the optical and the 3 }

\ImmediateObjective{The immediate objective of the proposal is to obtain multi-band observations of SNIa at close to 2 years after maximum light.
Using these multi-band observations, we would construct a pseudo-bolometric light curve. Comparing the decline rate to the energy deposition from 
$^{56}$Co allows us to determine the amount of positron escape and hence place constrains on the nature of the weak magnetic field and the structure of the ejecta. } 
...
\WhyLunarPhase{For our objects, we require observations during the new moon phase.}  
...
\TelescopeJustification{Observations of SNIa at late epochs ($>$ +200 days) require 8-m class telescopes since they are very faint in the 
NIR and the optical. Hence, we have requested for observations on FORS2 and HAWK-I}
...
\RequestedDataRemark{No, the requested data in }
